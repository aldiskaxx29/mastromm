        ...
        <div class="card">
          ...
          <div class="card-body">
              {{-- <div class="tak"> --}}
                  ...
                  <a href="{{ url('cetakLaporanInvoice') }}/{{ $dari }}/{{ $sampai }}" class="btn btn-danger" style="float: right;" target="_blank"><i class="fas fa-print"></i> Cetak Laporan</a>
              {{-- </div> --}}
              {{-- <div> --}}
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    {{-- <td>{{ $item->alamat }}</td> --}}
                    <td><a href="{{ url('cetak_satuanInvoice') }}/{{ $dari }}/{{ $sampai }}/{{ $item->id }}" target="__blank" class="btn btn-info btn-sm"><i class="fas fa-print"></i></a></td>
                </tr>                    
                @endforeach
